...
const _getAsBuffer = (logLevel, s, color) => exports.COLORED_OUT ?
    Buffer.concat([Buffer.from(`${color}[${logLevel}] `), s, Buffer.from(`${COLOR.reset}\n\n`)]) :
    Buffer.concat([Buffer.from(`[${logLevel}] `), s, Buffer.from(`\n\n`)]);
